  ...
  fetch('https://100.24.182.107/api/marloscardoso/listcategorias')
      .then(response => response.json())
      .then(data => {

          data.forEach(item => {
              const categoria = $('<div class="col-md-4"><a class="category-item" href="shop.html"><img class="img-fluid" src="img/card.png" alt="" /><strong class="category-item-title">' + item.titulo + '</strong></a></div>');
