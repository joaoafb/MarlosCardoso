...
async function sendData(data) {
    try {
        const response = await fetch("http://54.224.146.242/api/marloscardoso/loginusuario", {
            method: "POST",
            headers: {
...
async function sendDataCadastro(dados) {
    try {
        const response = await fetch("http://54.224.146.242/api/marloscardoso/cadastrocliente", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
