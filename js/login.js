...
async function sendData(data) {
    try {
        const response = await fetch("https://100.24.182.107/api/marloscardoso/loginusuario", {
            method: "POST",
            headers: {
...
async function sendDataCadastro(dados) {
    try {
        const response = await fetch("https://100.24.182.107/api/marloscardoso/cadastrocliente", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
